...
use ockam_api::nodes::service::NodeManagerTransportOptionsS;
use ockam_api::nodes::{
...
impl CreateCommand {
    ...
    pub(super) async fn foreground_mode(
        ...
        let udp_options = if self.udp {
            ...
            Some(NodeManagerTransportOptionsS::new(flow_control_id, udp))
        } else {
            None
        };
        ...
        let node_man = InMemoryNode::new(
            ...
            NodeManagerTransportOptions::new(
                NodeManagerTransportOptionsS::new(tcp_listener.flow_control_id().clone(), tcp),
                udp_options,
            ),
            trust_options,
        )
