...
pub struct CreateCommand {
    ...
    #[arg(default_value_t = kafka_default_outlet_addr())]
    pub name: String,
    ...
    /// Address of your Kafka Outlet, which is part of a route used in other commands.
    #[arg(long, id = "OUTLET_ADDRESS", visible_alias = "addr", default_value_t = kafka_default_outlet_addr())]
    pub from: String,

    /// The address of the kafka bootstrap broker
    #[arg(long, visible_alias = "to", default_value_t = kafka_default_outlet_server())]
