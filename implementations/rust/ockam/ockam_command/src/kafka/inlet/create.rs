...
pub struct CreateCommand {
    ...
    #[arg(default_value_t = kafka_inlet_default_addr())]
    pub name: String,
    ...
    /// The address and port where the client will connect, in the format <address>:<port>.
    /// If only a port is specified, the default address 127.0.0.1 will be used.
