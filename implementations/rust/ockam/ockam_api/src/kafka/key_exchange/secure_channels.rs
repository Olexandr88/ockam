...
use crate::kafka::key_exchange::listener::{
    KeyExchangeRequest, KeyExchangeResponse, KAFKA_KEY_EXCHANGE_LISTENER,
};
...
impl KafkaKeyExchangeControllerImpl {
    ...
    async fn ask_for_key_over_secure_channel(
        ...
        destination.push_back(Service::new(KAFKA_KEY_EXCHANGE_LISTENER))?;
